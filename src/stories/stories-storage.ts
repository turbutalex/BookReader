...
\n În cele din urmă, iepurele se dădu bătut şi spuse că de acum înainte nu va mai înfrunta pe nimeni.`
 ...
 export const povesteTrei = `A fost odată ca niciodată o purcea, care avea 3 purceluși, însă nu avea suficientă mâncare pentru toți trei. Așa că, atunci când s-au facut suficient de mari, mama i-a trimis în lume să își încerce norocul.
...
export const povestePatru = `Un şoarece înfumurat de la oraş veni în ospeţie la un şoarece de rând. Acesta locuia în câmp şi îşi ospăta musafirul cu ce-i era la îndemână — nişte boabe de grâu şi de mazăre. Şoarecele cel înfumurat ronţăi ce ronţăi la ele şi spuse:
...
export const povesteCinci = `Au fost odată doi frați, un băiat pe nume Hansel și o fetiță, Gretel, care trăiau cu tatăl, deoarece mama lor murise. Erau foarte săraci, dar fericiți. Însă, într-o zi, tatăl lor s-a recăsătorit cu o femeie foarte rea. Aceasta îi spuse soțului ei că trebuie să ducă copiii în pădure pentru că nu-și permiteau să-i hrănească.
\n Tatăl la început a refuzat, însă cu timpul se lăsă convins de femeia cea rea. Așa că în noaptea următoare, cei doi au luat copiii și îi duse în pădure. Cum Hansel știa despre planul lor deoarece îi auzise, strânse pietricele albe pe care le aruncă pe drum.
\n Mama vitregă cea rea împreună cu tatăl micuților i-a dus pe aceștia în pădure, după care s-au întors acasă. Dar Hansel și Gretel au găsit drumul înapoi spre casă datorită pietricelelor. Următoarea zi, mama vitregă decide să-i ducă din nou în pădure. Dar nu l-a mai lăsat pe Hansel să strângă pietricele albe, așa că micuții n-au mai găsit drumul spre casă și s-au pierdut.
\n Cum erau înfometați și obosiți, au început să meargă mai încet, dar ce să vezi? Au zărit în apropiere o casă din turtă dulce. Fericiți pentru descoperire, începu să mănânce din ea, dar între timp apăru o femeie bătrână care le spuse că va avea grijă de ei. La auzul acestei vești, Hansel și Gretel s-au bucurat tare, ei neștiind că această femeie era o vrăjitoare.
\n Vrăjitoarea l-a pus pe Hansel într-o cușcă și a început să-l îngrașe ca să-l poată mânca, iar pe Gretel a pus-o să facă toate treburile casnice.
\n Într-o zi femeia decise că este timpul să-l mănânce pe Hansel, așa că a pus-o pe Gretel să-i facă focul. Gretel trebuia să se gândească rapid la un plan ca să-și salveze fratele. Când focul s-a încins bine de tot, a chemat-o pe vrăjitoare și a rugat-o să vadă dacă a făcut bine.
\n Dar în timp ce vrăjitoarea verifica focul, Gretel a împins-o în flăcările mistuitoare, salvându-și astfel fratele. Iar cei doi frați au scăpat. Și-au făcut o căsuță pentru ei, și-au găsit fiecare perechea potrivită și au trăit fericiți toată viața.`